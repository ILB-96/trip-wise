...
const TripCover = ({
                       ...
                       tripImage,
                       numberOfDays,
                       averageRating, // Change this to averageRating
                       tripProfile,
                       tripCreatedAt,
                       tripCountry,
                   }: {
    ...
    tripImage: string;
    numberOfDays: number;
    averageRating: number; // Change this to averageRating
    ...
    return (
        <div className='relative w-full h-[500px] max-w-8xl mx-auto'>
            ...
            <span className='items-center inline-flex pt-2'>
              {renderStars(averageRating)} {/* Render stars based on averageRating */}
            </span>
                    </div>
